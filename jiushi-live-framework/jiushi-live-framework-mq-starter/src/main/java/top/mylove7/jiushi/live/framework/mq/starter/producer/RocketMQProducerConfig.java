package top.mylove7.jiushi.live.framework.mq.starter.producer;

import jakarta.annotation.Resource;
import org.apache.rocketmq.client.exception.MQClientException;
import org.apache.rocketmq.client.producer.DefaultMQProducer;
import org.apache.rocketmq.client.producer.MQProducer;
import top.mylove7.jiushi.live.framework.mq.starter.properties.RocketMQProducerProperties;
    ...
    public MQProducer mqProducer() {
        ThreadPoolExecutor asyncThreadPool = new ThreadPoolExecutor(Runtime.getRuntime().availableProcessors() * 2, 100, 30, TimeUnit.SECONDS, new ArrayBlockingQueue<>(2000), new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                return new Thread(r, "消息队列rocketmq-async-thread-" + new Random().ints().toString());
            }
        });
